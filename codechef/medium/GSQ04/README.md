...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-09-06T14:50:24.341Z  
...
(
    ...
    Employee_Name   char(20), /* TEXT Data type assigned to the variable */
    Department  char(20) /* TEXT Data type assigned to the variable */
);
```
